...
│                             · botón ayuda contextual (HelpCircle) — abre /manuales/{manual}.html en pestaña nueva
│                             BREADCRUMBS y MANUALES: claves deben coincidir con pathname EXACTO del router
│                             (ej: '/paciente' singular ≠ '/pacientes' — verificar App.jsx al agregar rutas)
│                             MANUALES: ruta → archivo de manual; el botón solo aparece si la ruta tiene manual.
│                             Los manuales viven en public/manuales/ (copia de docs/) — tras regenerar manuales
│                             o capturas correr desde frontend/: npm run sync:manuales
│   ├── persona/
│   │   ├── BuscadorPersona.jsx
│   │   └── FormPersona.jsx
│   ├── paciente/
