...
// ── Hooks ────────────────────────────────────────────────
function useEspecialidad(search = '') {
  return useQuery({
...
function useEspecialidadMutations() {
        ...
        <div className="panel-header">
          <div className="panel-header-left">
            ...
            <span className="panel-header-title">
              {esCreacion ? 'Nueva especialidad' : esEdicion ? 'Editar especialidad' : 'Detalle'}
            </span>
          </div>
        ...
        <div className="panel-body">
          ...
          <div className="panel-field">
            ...
            {esVista
              ...
              : <input name="descripcion" value={form.descripcion} onChange={handleChange} placeholder="Descripción..." className="panel-input" autoFocus={esEdicion} />
            }
          </div>
        </div>
...
export default function EspecialidadPage() {
  ...
  const { data, isLoading } = useEspecialidad(search)
    ...
    <>
      ...
      <div className="con-root">
        <div className="con-header">
          <div>
            <div className="con-title">Especialidades</div>
            <div className="con-subtitle">
              {especialidades.length > 0
                ? `${especialidades.length} especialidades registrados`
