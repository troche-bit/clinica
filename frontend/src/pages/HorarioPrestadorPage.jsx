...
} from '../hooks/useHorarioPrestador'
...
// Calcula previsualización de turnos en el frontend
...
// ── TimeInput — fuerza formato HH:MM (24 horas) ────────────────────────────
  ...
  return (
    <div className={`hp-bloque${esExcepcion ? ' hp-bloque-exc' : ''}`}>
      ...
      <div className="hp-bloque-fields">
        ...
        {/* Especialidades — checkboxes filtrados al prestador */}
...
export default function HorarioPrestadorPage() {
  ...
  // Especialidades del prestador seleccionado
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .hp-gen-nota   { font-size: 11px; color: #9ca3af; margin-top: 6px; }
        ...
        /* Grid — FIX de overflow: min-width: 0 en cada celda */
        ...
        /* width: 100% + box-sizing para que nunca desborden */
        .hp-input, .hp-select {
          width: 100%; box-sizing: border-box;
          padding: 8px 10px; border: 1.5px solid #e5e7eb; border-radius: 8px;
          font-size: 13px; font-family: 'DM Sans', sans-serif; color: #111827; outline: none;
                    ...
                    <div className="hp-gen-section">
                      ...
                      {genResult && (
                        <div className="hp-gen-result">
                          <strong>Resultado:</strong> {genResult.creados} turno(s) procesado(s)
                          {genResult.detalle?.map((d, i) => (
                            <div key={i} style={{ marginTop: 4 }}>{d.fecha} · {d.dia}: {d.turnos_creados} turno(s)</div>
                          ))}
                          <div className="hp-gen-nota">Módulo Agenda pendiente — los turnos no se persistieron aún.</div>
                        </div>
                      )}
