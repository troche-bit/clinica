...
import {
  Bell, Calendar, Clock, AlertTriangle, CheckCircle,
  User, Phone, Mail, ChevronRight, X, Send, ExternalLink,
} from 'lucide-react'
import {
  useProximasCitas,
...
export default function RecordatoriosPage() {
  ...
  const [periodo,   setPeriodo]   = useState('30dias') // vencidas|7dias|30dias|todos
  const [medico,    setMedico]    = useState('')
  const [estadoF,   setEstadoF]   = useState('')       // pendiente|agendado
