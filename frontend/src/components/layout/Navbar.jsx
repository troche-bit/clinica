...
const BREADCRUMBS = {
  ...
  '/informes':                     ['Informes'],
  '/informes/stock':               ['Gestión', 'Informes'],
  '/informes/dashboard/facturacion': ['Gestión', 'Dashboard Facturación'],
  '/informes/dashboard/finanzas':    ['Gestión', 'Dashboard Finanzas'],
  '/informes/dashboard/cobranzas':   ['Gestión', 'Dashboard Cobranzas'],
