...
// Obtiene la lista de especialidades. Sin parámetro de búsqueda trae todas (page_size=200).
export function useEspecialidades(search = '') {
  return useQuery({
    ...
    staleTime: 5 * 60 * 1000,  // 5 minutos — los catálogos cambian poco
  })
}

// Mutaciones CRUD para especialidades: crear, actualizar (PATCH) y eliminar
