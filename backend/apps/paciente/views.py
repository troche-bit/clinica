...
class PacienteResponsableViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self): # Sobrescribimos el método get_serializer_class para personalizar el serializer
        if self.action in ['list', 'retrieve']: # Si la acción es listar o recuperar un paciente
            return PacienteResponsableListSerializer # Usamos el serializer de lista
        return PacienteResponsableSerializer # De lo contrario, usamos el serializer estándar
