...
from .views import EventoClinicoViewSet # Importamos los ViewSets para cada modelo

router = DefaultRouter() # Creamos una instancia del enrutador
router.register(r'eventoclinico', EventoClinicoViewSet, basename = 'eventoclinico') # Registramos el ViewSet de Países con el prefijo 'paises' y el nombre base 'pais'
