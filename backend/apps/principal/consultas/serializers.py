...
class ConsultaPacienteSerializer(serializers.Serializer):
    """Datos del paciente embebidos en la consulta — solo lectura."""
...
class ConsultaMedicoSerializer(serializers.Serializer):
    """Datos del médico embebidos en la consulta — solo lectura."""
...
class ConsultaAgendaSerializer(serializers.Serializer):
    """Datos de la agenda embebidos en la consulta — solo lectura."""
    id         = serializers.IntegerField()
