...
class HorarioPrestadorViewSet(viewsets.ModelViewSet):
    ...
    def generar(self, request, pk=None):
        """
        Genera los turnos del horario para un rango de fechas.
        Crea registros en Agenda con estado=disponible.
        Omite los turnos que ya existen (is_deleted=False).
        """
        ...
        for i in range((fecha_hasta - fecha_desde).days + 1):
            ...
            # Verificar si este horario aplica en la fecha actual
