...
from apps.administracion.users.views import CustomTokenObtainPairView
...
urlpatterns = [
    ...
    path('api/', include('apps.administracion.users.urls')),
    path('api/', include('apps.mantenimiento.ubicacion.urls')),
    path('api/', include('apps.mantenimiento.diasemana.urls')),
    ...
    path('api/', include('apps.clinica.agenda.urls')),
    # Módulos clínicos
    ...
    path('api/', include('apps.clinica.consultas.urls')),
    path('api/', include('apps.clinica.configuracion.documentos.urls')),
    path('api/', include('apps.mantenimiento.notificaciones.urls')),
    # Módulos de mantenimiento del sistema
    path('api/', include('apps.forma_pago.urls')),
    path('api/', include('apps.finanzas.caja_banco.urls')),
    path('api/', include('apps.facturacion.ventas.urls')),
    path('api/', include('apps.finanzas.cobranzas.urls')),
