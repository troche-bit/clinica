...
class StandardPagination(PageNumberPagination): # Creamos una clase de paginación personalizada llamada StandardPagination que hereda de PageNumberPagination.
    ...
    max_page_size          = 200 # Establecemos el número máximo de elementos por página a 100. Esto significa que aunque el cliente solicite más de 100 elementos por página, solo se devolverán 100.
